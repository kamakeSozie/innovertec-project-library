...
$( document ).ready(function() {
	...
	var userNAME = ${ username };
		$.ajax({
			type: "GET",
			url: "http://localhost:8080/userPage?nameUser="+userNAME,
			setTimeout: false,
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
        <a class="nav-link" href="/userPage">Listes <span class="sr-only">(current)</span></a>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
      ...
      <a class="nav-link" href="/logout"><b>Se Déconnecter</b> <span class="sr-only"></span></a>
				...
				<c:forEach items="${ projetByUser }" var="projects">
					<option value="${projects.projetName}&${projects.projetId}">
						${projects.projetName}
					</option>
				</c:forEach>
				</select>
...
<div class="col-md-6 mr-auto ml-auto mt-5 pt-5 text-center" id="bienvenue">
<div class="card bg-info text-white">
	<h3><b><u>Bienvenue : ${ username }</u> dans votre espace de travail !</b></h3></br>
